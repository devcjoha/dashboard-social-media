      ...
      transition duration-200 ease-in">
        <input
          ...
          className="input-mode peer appearance-none w-12 h-6 rounded-full
            bg-bg-toggle hover:bg-linear-to-r from-blue-500 to-green-500 
        ...
        <label
          ...
          bg-white-bg dark:bg-card-bg-navy border rounded-full border-slate-300 dark:border-none shadow-sm 
